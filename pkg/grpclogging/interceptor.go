...
// LevelerFunc is a function adapter for the Leveler and PayloadLeveler
// interfaces.
...
// PayloadLevel implements the PayloadLeveler interface.
...
// WithLeveler provides a custom Leveler implementation determines the level at
// which a log record for a method invocation should be emitted.
func WithLeveler(l Leveler) Option {
	return func(o *options) { o.Leveler = l }
}

// WithPayloadLeveler provides a custom PayloadLeveler implementation
// determines the level at which a log record containing the request and
// response messages for a method invocation should be emitted.
...
// UnaryServerInterceptor returns an interceptor that logs gRPC request
// information and decorates the context with zap.Field data.
...
// StreamServerInterceptor returns an interceptor that logs gRPC request
// information and decorates the context with zap.Field data.
