...
// 	protoc        v3.13.0
// source: transaction/resolved.proto
...
func (x *ResolvedState) Reset() {
	*x = ResolvedState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_transaction_resolved_proto_msgTypes[0]
...
func (*ResolvedState) Descriptor() ([]byte, []int) {
	return file_transaction_resolved_proto_rawDescGZIP(), []int{0}
}
...
func (x *Signer) Reset() {
	*x = Signer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_transaction_resolved_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Signer) Descriptor() ([]byte, []int) {
	return file_transaction_resolved_proto_rawDescGZIP(), []int{1}
}
...
func (x *ResolvedTransaction) Reset() {
	*x = ResolvedTransaction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_transaction_resolved_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResolvedTransaction) Descriptor() ([]byte, []int) {
	return file_transaction_resolved_proto_rawDescGZIP(), []int{2}
}
...
var File_transaction_resolved_proto protoreflect.FileDescriptor

var file_transaction_resolved_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x72, 0x65,
	0x73, 0x6f, 0x6c, 0x76, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x1d, 0x74, 0x72, 0x61, 0x6e, 0x73,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x73,
	0x6f, 0x6c, 0x76, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x78,
	...
	0x78, 0x12, 0x2a, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x16, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x0a,
	0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x22, 0x46, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x12, 0x1e, 0x0a,
	...
	0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x85, 0x02, 0x0a, 0x13,
	...
	0x6e, 0x63, 0x65, 0x73, 0x12, 0x2d, 0x0a, 0x07, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x73, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x52, 0x07, 0x73, 0x69, 0x67, 0x6e,
	0x65, 0x72, 0x73, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x69, 0x62,
	0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x61, 0x74, 0x69, 0x6b, 0x2f, 0x62, 0x61, 0x74, 0x69,
	0x6b, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_transaction_resolved_proto_rawDescOnce sync.Once
	file_transaction_resolved_proto_rawDescData = file_transaction_resolved_proto_rawDesc
)

func file_transaction_resolved_proto_rawDescGZIP() []byte {
	file_transaction_resolved_proto_rawDescOnce.Do(func() {
		file_transaction_resolved_proto_rawDescData = protoimpl.X.CompressGZIP(file_transaction_resolved_proto_rawDescData)
	})
	return file_transaction_resolved_proto_rawDescData
}

var file_transaction_resolved_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_transaction_resolved_proto_goTypes = []interface{}{
	(*ResolvedState)(nil),       // 0: transaction.ResolvedState
	(*Signer)(nil),              // 1: transaction.Signer
	(*ResolvedTransaction)(nil), // 2: transaction.ResolvedTransaction
	(*StateInfo)(nil),           // 3: transaction.StateInfo
	(*Transaction)(nil),         // 4: transaction.Transaction
}
var file_transaction_resolved_proto_depIdxs = []int32{
	3, // 0: transaction.ResolvedState.info:type_name -> transaction.StateInfo
	4, // 1: transaction.ResolvedTransaction.transaction:type_name -> transaction.Transaction
	0, // 2: transaction.ResolvedTransaction.inputs:type_name -> transaction.ResolvedState
	0, // 3: transaction.ResolvedTransaction.references:type_name -> transaction.ResolvedState
	1, // 4: transaction.ResolvedTransaction.signers:type_name -> transaction.Signer
...
func init() { file_transaction_resolved_proto_init() }
func file_transaction_resolved_proto_init() {
	if File_transaction_resolved_proto != nil {
		return
	}
	file_transaction_transaction_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_transaction_resolved_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_transaction_resolved_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Signer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_transaction_resolved_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_transaction_resolved_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_transaction_resolved_proto_goTypes,
		DependencyIndexes: file_transaction_resolved_proto_depIdxs,
		MessageInfos:      file_transaction_resolved_proto_msgTypes,
	}.Build()
	File_transaction_resolved_proto = out.File
	file_transaction_resolved_proto_rawDesc = nil
	file_transaction_resolved_proto_goTypes = nil
	file_transaction_resolved_proto_depIdxs = nil
}
