...
func (c *atomicBroadcastAPIClient) Broadcast(ctx context.Context, opts ...grpc.CallOption) (AtomicBroadcastAPI_BroadcastClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AtomicBroadcastAPI_serviceDesc.Streams[0], "/orderer.v1.AtomicBroadcastAPI/Broadcast", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *atomicBroadcastAPIClient) Deliver(ctx context.Context, opts ...grpc.CallOption) (AtomicBroadcastAPI_DeliverClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AtomicBroadcastAPI_serviceDesc.Streams[1], "/orderer.v1.AtomicBroadcastAPI/Deliver", opts...)
	if err != nil {
		return nil, err
	}
...
var _AtomicBroadcastAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "orderer.v1.AtomicBroadcastAPI",
	...
	Metadata: "orderer/v1/atomic_broadcast_api.proto",
}
