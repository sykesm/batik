...
func RegisterStoreAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StoreAPIServer) error {
	...
	mux.Handle("GET", pattern_StoreAPI_GetTransaction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/store.StoreAPI/GetTransaction")
		if err != nil {
...
func RegisterStoreAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StoreAPIClient) error {
	...
	mux.Handle("GET", pattern_StoreAPI_GetTransaction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/store.StoreAPI/GetTransaction")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_StoreAPI_GetTransaction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "store", "transaction", "txid"}, ""))
)
